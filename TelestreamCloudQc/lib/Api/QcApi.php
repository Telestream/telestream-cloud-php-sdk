...
class QcApi
{
     ...
     * @throws \TelestreamCloudQc\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TelestreamCloudQc\Model\Template[]
     */
     ...
     * @throws \TelestreamCloudQc\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TelestreamCloudQc\Model\Template[], HTTP status code, HTTP response headers (array of strings)
     */
    public function templatesWithHttpInfo()
    {
        $returnType = '\TelestreamCloudQc\Model\Template[]';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TelestreamCloudQc\Model\Template[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function templatesRequest()
    {

        $resourcePath = '/templates.json';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';

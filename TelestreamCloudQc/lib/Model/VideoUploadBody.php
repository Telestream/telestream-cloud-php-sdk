...
class VideoUploadBody implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'file_size' => 'int',
        'file_name' => 'string',
        'extra_files' => '\TelestreamCloudQc\Model\ExtraFile[]',
        'profiles' => 'string',
        'multi_chunk' => 'bool'
    ];
     ...
     * Gets extra_files
     *
     * @return \TelestreamCloudQc\Model\ExtraFile[]
     */
     ...
     * Sets extra_files
     *
     * @param \TelestreamCloudQc\Model\ExtraFile[] $extra_files A list of names of additional files that will be uploaded.
     *
     * @return $this
     */

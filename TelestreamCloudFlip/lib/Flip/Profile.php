...
class Profile implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        $allowed_values = $this->getAudioFormatAllowableValues();
        if (!in_array($this->container['audio_format'], $allowed_values)) {
            $invalid_properties[] = sprintf(
        ...
        $allowed_values = $this->getDnxhdTypeAllowableValues();
        if (!in_array($this->container['dnxhd_type'], $allowed_values)) {
            $invalid_properties[] = sprintf(
        ...
        $allowed_values = $this->getPlaylistTypeAllowableValues();
        if (!in_array($this->container['playlist_type'], $allowed_values)) {
            $invalid_properties[] = sprintf(
        ...
        $allowed_values = $this->getEac3AnalogToDigitalConverterTypeAllowableValues();
        if (!in_array($this->container['eac3_analog_to_digital_converter_type'], $allowed_values)) {
            $invalid_properties[] = sprintf(
    ...
    {
        $allowed_values = $this->getAudioFormatAllowableValues();
        if (!is_null($audio_format) && !in_array($audio_format, $allowed_values)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'audio_format', must be one of '%s'",
                    implode("', '", $allowed_values)
     ...
     * @param bool $byte_range_requests
     * @return $this
     */
    ...
    {
        $allowed_values = $this->getDnxhdTypeAllowableValues();
        if (!is_null($dnxhd_type) && !in_array($dnxhd_type, $allowed_values)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'dnxhd_type', must be one of '%s'",
                    implode("', '", $allowed_values)
    ...
    {
        $allowed_values = $this->getPlaylistTypeAllowableValues();
        if (!is_null($playlist_type) && !in_array($playlist_type, $allowed_values)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'playlist_type', must be one of '%s'",
                    implode("', '", $allowed_values)
    ...
    {
        $allowed_values = $this->getPresetNameAllowableValues();
        if (!is_null($preset_name) && !in_array($preset_name, $allowed_values)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'preset_name', must be one of '%s'",
                    implode("', '", $allowed_values)
     ...
     * @param bool $telestream_subpel_mode
     * @return $this
     */
    ...
    {
        $allowed_values = $this->getEac3AnalogToDigitalConverterTypeAllowableValues();
        if (!is_null($eac3_analog_to_digital_converter_type) && !in_array($eac3_analog_to_digital_converter_type, $allowed_values)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'eac3_analog_to_digital_converter_type', must be one of '%s'",
                    implode("', '", $allowed_values)

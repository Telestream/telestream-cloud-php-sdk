 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class FactorySyncBody implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        $allowed_values = $this->getSyncAllowableValues();
        if (!in_array($this->container['sync'], $allowed_values)) {
    ...
    {
        $allowed_values = $this->getSyncAllowableValues();
        if (!in_array($sync, $allowed_values)) {

...
/**
 * EncodingSignedUrl Class Doc Comment
 *
 * @category Class
 * @package  TelestreamCloudFlip
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class EncodingSignedUrl implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'EncodingSignedUrl';
     ...
     * Sets signed_url
     *
     * @param string $signed_url A signed URLs pointing to the encoding's output.
     *
     * @return $this
     */

...
class Encoding implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param int $encoding_progress encoding_progress
     *
     * @return $this
     */
     ...
     * Sets encoding_time
     *
     * @param int $encoding_time encoding_time
     *
     * @return $this
     */
     ...
     * Sets file_size
     *
     * @param int $file_size A size of the output file.
     *
     * @return $this
     */
     ...
     * Sets video_bitrate
     *
     * @param int $video_bitrate video bitrate (in bits/s)
     *
     * @return $this
     */

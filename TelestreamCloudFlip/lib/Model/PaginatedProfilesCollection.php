...
/**
 * PaginatedProfilesCollection Class Doc Comment
 *
 * @category Class
 * @package  TelestreamCloudFlip
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PaginatedProfilesCollection implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PaginatedProfilesCollection';
    ...
    protected static $swaggerTypes = [
        'profiles' => '\TelestreamCloudFlip\Model\Profile[]',
        'page' => 'int',
        'per_page' => 'int',
        'total' => 'int'
    ];
     ...
     * Sets profiles
     *
     * @param \TelestreamCloudFlip\Model\Profile[] $profiles profiles
     *
     * @return $this
     */
     ...
     * Sets per_page
     *
     * @param int $per_page A number of profiles per page.
     *
     * @return $this
     */
     ...
     * Sets total
     *
     * @param int $total A number of all profiles stored in the db.
     *
     * @return $this
     */

...
class Profile implements ModelInterface, ArrayAccess
{
    ...
    const AUDIO_FORMAT_S24LE = 'pcm_s24le';
    const AUDIO_FORMAT_S16LE = 'pcm_s16le';
    ...
    const DNXHD_TYPE__36 = '36';
    const DNXHD_TYPE__45 = '45';
    const DNXHD_TYPE__60 = '60';
    const DNXHD_TYPE__75 = '75';
    const DNXHD_TYPE__90 = '90';
    const DNXHD_TYPE__90X = '90x';
    const DNXHD_TYPE__110 = '110';
    const DNXHD_TYPE__115 = '115';
    const DNXHD_TYPE__120 = '120';
    const DNXHD_TYPE__145 = '145';
    const DNXHD_TYPE__175X = '175x';
    const DNXHD_TYPE__175 = '175';
    const DNXHD_TYPE__185X = '185x';
    const DNXHD_TYPE__185 = '185';
    const DNXHD_TYPE__220X = '220x';
    const DNXHD_TYPE__220 = '220';
    ...
    const PLAYLIST_TYPE_IFRAME = 'iframe';
    const PLAYLIST_TYPE_IFRAME_ONLY = 'iframe-only';
    ...
    const EAC3_ANALOG_TO_DIGITAL_CONVERTER_TYPE_STANDARD = 'standard';
    const EAC3_ANALOG_TO_DIGITAL_CONVERTER_TYPE_HDCD = 'hdcd';
    ...
    {
        return [
            self::AUDIO_FORMAT_S24LE,
            self::AUDIO_FORMAT_S16LE,
        ];
    }
     ...
     * @return string[]
     */
    public function getDnxhdTypeAllowableValues()
    {
        return [
            self::DNXHD_TYPE__36,
            self::DNXHD_TYPE__45,
            ...
            self::DNXHD_TYPE__75,
            self::DNXHD_TYPE__90,
            self::DNXHD_TYPE__90X,
            self::DNXHD_TYPE__110,
            self::DNXHD_TYPE__115,
            self::DNXHD_TYPE__120,
            self::DNXHD_TYPE__145,
            self::DNXHD_TYPE__175X,
            self::DNXHD_TYPE__175,
            self::DNXHD_TYPE__185X,
            self::DNXHD_TYPE__185,
            self::DNXHD_TYPE__220X,
            self::DNXHD_TYPE__220,
        ];
    }
     ...
     * @return string[]
     */
    public function getPlaylistTypeAllowableValues()
    {
        return [
            self::PLAYLIST_TYPE_IFRAME,
            self::PLAYLIST_TYPE_IFRAME_ONLY,
        ];
    }
     ...
     * @return string[]
     */
    public function getEac3AnalogToDigitalConverterTypeAllowableValues()
    {
        return [
            self::EAC3_ANALOG_TO_DIGITAL_CONVERTER_TYPE_STANDARD,
            self::EAC3_ANALOG_TO_DIGITAL_CONVERTER_TYPE_HDCD,
        ];
    }
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getAdvancedFpsConversionAllowableValues();
        if (!in_array($this->container['advanced_fps_conversion'], $allowedValues)) {
        ...
        if (!in_array($this->container['aspect_mode'], $allowedValues)) {
            $invalidProperties[] = sprintf(
        ...
        $allowedValues = $this->getAudioChannelsLayoutAllowableValues();
        if (!in_array($this->container['audio_channels_layout'], $allowedValues)) {
            $invalidProperties[] = sprintf(
        ...
        if (!in_array($this->container['audio_format'], $allowedValues)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'audio_format', must be one of '%s'",
                implode("', '", $allowedValues)
            );
        }

        $allowedValues = $this->getAvcintraClassAllowableValues();
        if (!in_array($this->container['avcintra_class'], $allowedValues)) {
            $invalidProperties[] = sprintf(
        ...
        $allowedValues = $this->getClosedCaptionsAllowableValues();
        if (!in_array($this->container['closed_captions'], $allowedValues)) {
            $invalidProperties[] = sprintf(
        ...
        $allowedValues = $this->getDeinterlaceAllowableValues();
        if (!in_array($this->container['deinterlace'], $allowedValues)) {
            $invalidProperties[] = sprintf(
        ...
        $allowedValues = $this->getDnxhdTypeAllowableValues();
        if (!in_array($this->container['dnxhd_type'], $allowedValues)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'dnxhd_type', must be one of '%s'",
                implode("', '", $allowedValues)
            );
        }

        $allowedValues = $this->getH264LevelAllowableValues();
        if (!in_array($this->container['h264_level'], $allowedValues)) {
            $invalidProperties[] = sprintf(
        ...
        $allowedValues = $this->getH264ProfileAllowableValues();
        if (!in_array($this->container['h264_profile'], $allowedValues)) {
            $invalidProperties[] = sprintf(
        ...
        $allowedValues = $this->getH264TuneAllowableValues();
        if (!in_array($this->container['h264_tune'], $allowedValues)) {
            $invalidProperties[] = sprintf(
        ...
        $allowedValues = $this->getPlaylistTypeAllowableValues();
        if (!in_array($this->container['playlist_type'], $allowedValues)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'playlist_type', must be one of '%s'",
                implode("', '", $allowedValues)
            );
        }

        $allowedValues = $this->getPresetNameAllowableValues();
        if (!in_array($this->container['preset_name'], $allowedValues)) {
            $invalidProperties[] = sprintf(
        ...
        $allowedValues = $this->getTelestreamBlockSizeAllowableValues();
        if (!in_array($this->container['telestream_block_size'], $allowedValues)) {
            $invalidProperties[] = sprintf(
        ...
        $allowedValues = $this->getTachyonMotionAmountAllowableValues();
        if (!in_array($this->container['tachyon_motion_amount'], $allowedValues)) {
            $invalidProperties[] = sprintf(
        ...
        $allowedValues = $this->getTachyonFallbackSizeAllowableValues();
        if (!in_array($this->container['tachyon_fallback_size'], $allowedValues)) {
            $invalidProperties[] = sprintf(
        ...
        $allowedValues = $this->getTachyonMblockSizeAllowableValues();
        if (!in_array($this->container['tachyon_mblock_size'], $allowedValues)) {
            $invalidProperties[] = sprintf(
        ...
        $allowedValues = $this->getEac3BitstreamModeAllowableValues();
        if (!in_array($this->container['eac3_bitstream_mode'], $allowedValues)) {
            $invalidProperties[] = sprintf(
        ...
        $allowedValues = $this->getEac3AnalogToDigitalConverterTypeAllowableValues();
        if (!in_array($this->container['eac3_analog_to_digital_converter_type'], $allowedValues)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'eac3_analog_to_digital_converter_type', must be one of '%s'",
                implode("', '", $allowedValues)
            );
        }

        $allowedValues = $this->getEac3StereoDownmixPreferenceAllowableValues();
        if (!in_array($this->container['eac3_stereo_downmix_preference'], $allowedValues)) {
            $invalidProperties[] = sprintf(
        ...
        $allowedValues = $this->getEac3LtRtCenterMixLevelAllowableValues();
        if (!in_array($this->container['eac3_lt_rt_center_mix_level'], $allowedValues)) {
            $invalidProperties[] = sprintf(
        ...
        $allowedValues = $this->getEac3LtRtSurroundMixLevelAllowableValues();
        if (!in_array($this->container['eac3_lt_rt_surround_mix_level'], $allowedValues)) {
            $invalidProperties[] = sprintf(
        ...
        $allowedValues = $this->getEac3LoRoCenterMixLevelAllowableValues();
        if (!in_array($this->container['eac3_lo_ro_center_mix_level'], $allowedValues)) {
            $invalidProperties[] = sprintf(
        ...
        $allowedValues = $this->getEac3LoRoSurroundMixLevelAllowableValues();
        if (!in_array($this->container['eac3_lo_ro_surround_mix_level'], $allowedValues)) {
            $invalidProperties[] = sprintf(
        ...
        $allowedValues = $this->getEac3SurroundExModeAllowableValues();
        if (!in_array($this->container['eac3_surround_ex_mode'], $allowedValues)) {
            $invalidProperties[] = sprintf(
        ...
        $allowedValues = $this->getEac3DrcLineModeProfileAllowableValues();
        if (!in_array($this->container['eac3_drc_line_mode_profile'], $allowedValues)) {
            $invalidProperties[] = sprintf(
        ...
        $allowedValues = $this->getEac3DrcRfModeProfileAllowableValues();
        if (!in_array($this->container['eac3_drc_rf_mode_profile'], $allowedValues)) {
            $invalidProperties[] = sprintf(
        ...
        $allowedValues = $this->getEac3RoomTypeAllowableValues();
        if (!in_array($this->container['eac3_room_type'], $allowedValues)) {
            $invalidProperties[] = sprintf(
    ...
    {
        $allowedValues = $this->getAdvancedFpsConversionAllowableValues();
        if (!is_null($advanced_fps_conversion) && !in_array($advanced_fps_conversion, $allowedValues)) {
     ...
     * Sets aspect_mode
     *
     * @param string $aspect_mode Specifies an aspect mode for output videos. The following options are available:   - letterbox:   - pad: Add paddings to the input image. Default is \"letterbox\".
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getAspectModeAllowableValues();
        if (!is_null($aspect_mode) && !in_array($aspect_mode, $allowedValues)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'aspect_mode', must be one of '%s'",
                    implode("', '", $allowedValues)
     ...
     * Sets aspect_ratio
     *
     * @param string $aspect_ratio A display aspect ratio. By default it is not set.
     *
     * @return $this
     */
     ...
     * Sets audio_channels
     *
     * @param int $audio_channels A number of audio channels. By default it is not set.
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getAudioChannelsLayoutAllowableValues();
        if (!is_null($audio_channels_layout) && !in_array($audio_channels_layout, $allowedValues)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'audio_channels_layout', must be one of '%s'",
                    implode("', '", $allowedValues)
     ...
     *
     * @param int $audio_channels_per_track A number of audio channels per track.
     *
     * @return $this
     */
     ...
     * Sets audio_codec
     *
     * @param string $audio_codec Audio codec that will be used by the profile. Available codecs are: `libmp3lame`, `libvorbis`, `libfdk_aac`, `dib_ac3, `pcm_s16le`, `mp2`, `ac3`, `eac3`.
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getAudioFormatAllowableValues();
        if (!is_null($audio_format) && !in_array($audio_format, $allowedValues)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'audio_format', must be one of '%s'",
                    implode("', '", $allowedValues)
     ...
     * Sets audio_map
     *
     * @param string $audio_map audio_map
     *
     * @return $this
     */
     ...
     * Sets audio_profile
     *
     * @param string $audio_profile Specifies an audio profile.
     *
     * @return $this
     */
     ...
     *
     * @param string $audio_sample_rate The number of samples of audio carried per second.
     *
     * @return $this
     */
     ...
     *
     * @param int $audio_stream_id audio_stream_id
     *
     * @return $this
     */
     ...
     * Sets audio_streams
     *
     * @param int $audio_streams A number of audio streams.
     *
     * @return $this
     */
     ...
     * Sets avcintra_class
     *
     * @param string $avcintra_class A class of the AVC-Intra video coding.
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getAvcintraClassAllowableValues();
        if (!is_null($avcintra_class) && !in_array($avcintra_class, $allowedValues)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'avcintra_class', must be one of '%s'",
                    implode("', '", $allowedValues)
     ...
     * Sets buffer_size
     *
     * @param string $buffer_size Determines the size of the PulseAudio buffer. by default it is not set.
     *
     * @return $this
     */
     ...
     *
     * @param bool $byte_range_requests byte_range_requests
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getClosedCaptionsAllowableValues();
        if (!is_null($closed_captions) && !in_array($closed_captions, $allowedValues)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'closed_captions', must be one of '%s'",
                    implode("', '", $allowedValues)
     ...
     * Sets color_metadata
     *
     * @param bool $color_metadata color_metadata
     *
     * @return $this
     */
     ...
     * Sets created_at
     *
     * @param string $created_at A date and time when the Profile has been created.
     *
     * @return $this
     */
     ...
     * Sets dash_profile
     *
     * @param string $dash_profile dash_profile
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getDeinterlaceAllowableValues();
        if (!is_null($deinterlace) && !in_array($deinterlace, $allowedValues)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'deinterlace', must be one of '%s'",
                    implode("', '", $allowedValues)
     ...
     *
     * @param string $deinterlace_frames deinterlace_frames
     *
     * @return $this
     */
     ...
     * Sets dnxhd_type
     *
     * @param string $dnxhd_type dnxhd_type
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getDnxhdTypeAllowableValues();
        if (!is_null($dnxhd_type) && !in_array($dnxhd_type, $allowedValues)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'dnxhd_type', must be one of '%s'",
                    implode("', '", $allowedValues)
     ...
     * Sets fps
     *
     * @param string $fps Null value copy the original fps. By default it is not set.
     *
     * @return $this
     */
     ...
     * Sets frame_count
     *
     * @param string $frame_count Evenly spaced number of generated screenshots. By default it is not set.
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getH264LevelAllowableValues();
        if (!is_null($h264_level) && !in_array($h264_level, $allowedValues)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'h264_level', must be one of '%s'",
                    implode("', '", $allowedValues)
    ...
    {
        $allowedValues = $this->getH264ProfileAllowableValues();
        if (!is_null($h264_profile) && !in_array($h264_profile, $allowedValues)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'h264_profile', must be one of '%s'",
                    implode("', '", $allowedValues)
     ...
     * Sets h264_tune
     *
     * @param string $h264_tune Specifies a h264 tuning option.
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getH264TuneAllowableValues();
        if (!is_null($h264_tune) && !in_array($h264_tune, $allowedValues)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'h264_tune', must be one of '%s'",
                    implode("', '", $allowedValues)
     ...
     * Sets imx_type
     *
     * @param string $imx_type imx_type
     *
     * @return $this
     */
     ...
     * Sets interlace
     *
     * @param string $interlace interlace
     *
     * @return $this
     */
     ...
     *
     * @param string $keyframe_interval Adds a key frame every N frames. Default is 250, adds a key frame every 250 frames.
     *
     * @return $this
     */
     ...
     * Sets keyframe_rate
     *
     * @param string $keyframe_rate todo
     *
     * @return $this
     */
     ...
     * Sets max_rate
     *
     * @param string $max_rate A max bitrate tolerance (in bits/s). By default this is not set.
     *
     * @return $this
     */
     ...
     *
     * @param string $merge_audio_streams merge_audio_streams
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string $name A unique machine-readable name that will identify the profile. Helpful later on for filtering encodings by profile.
     *
     * @return $this
     */
     ...
     * Sets playlist_type
     *
     * @param string $playlist_type playlist_type
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getPlaylistTypeAllowableValues();
        if (!is_null($playlist_type) && !in_array($playlist_type, $allowedValues)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'playlist_type', must be one of '%s'",
                    implode("', '", $allowedValues)
    ...
    {
        $allowedValues = $this->getPresetNameAllowableValues();
        if (!is_null($preset_name) && !in_array($preset_name, $allowedValues)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'preset_name', must be one of '%s'",
                    implode("', '", $allowedValues)
     ...
     * Sets prores_format
     *
     * @param string $prores_format prores_format
     *
     * @return $this
     */
     ...
     * Sets segment_time
     *
     * @param int $segment_time Minimum value is 2, maximum is 60.
     *
     * @return $this
     */
     ...
     *
     * @param string $telestream_block_size telestream_block_size
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getTelestreamBlockSizeAllowableValues();
        if (!is_null($telestream_block_size) && !in_array($telestream_block_size, $allowedValues)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'telestream_block_size', must be one of '%s'",
                    implode("', '", $allowedValues)
     ...
     *
     * @param float $telestream_blur_scaler Minimum value is 0, maximum is 4.
     *
     * @return $this
     */
     ...
     *
     * @param float $telestream_cost_scaler Minimum value is 0, maximum is 4.
     *
     * @return $this
     */
     ...
     *
     * @param int $telestream_search_length_scaler Minimum value is 0, maximum is 2.
     *
     * @return $this
     */
     ...
     *
     * @param bool $telestream_subpel_mode telestream_subpel_mode
     *
     * @return $this
     */
     ...
     * Sets time_code
     *
     * @param string $time_code If set, timestamps will be added to your videos. By default this is not set.
     *
     * @return $this
     */
     ...
     * Sets trailers
     *
     * @param string $trailers trailers
     *
     * @return $this
     */
     ...
     * Sets transport_rate
     *
     * @param string $transport_rate transport_rate
     *
     * @return $this
     */
     ...
     * Sets use_editlist
     *
     * @param bool $use_editlist use_editlist
     *
     * @return $this
     */
     ...
     * Sets video_pid
     *
     * @param string $video_pid video_pid
     *
     * @return $this
     */
     ...
     *
     * @param bool $watermark_bumpers watermark_bumpers
     *
     * @return $this
     */
     ...
     *
     * @param bool $watermark_trailers watermark_trailers
     *
     * @return $this
     */
     ...
     * Sets x264_options
     *
     * @param string $x264_options x264_options
     *
     * @return $this
     */
     ...
     * Sets x265_options
     *
     * @param string $x265_options x265_options
     *
     * @return $this
     */
     ...
     * Sets xdcam_format
     *
     * @param string $xdcam_format xdcam_format
     *
     * @return $this
     */
     ...
     *
     * @param bool $tachyon_media_hint_is_cartoon tachyon_media_hint_is_cartoon
     *
     * @return $this
     */
     ...
     *
     * @param bool $tachyon_allow_add_standard_pd tachyon_allow_add_standard_pd
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getTachyonMotionAmountAllowableValues();
        if (!is_null($tachyon_motion_amount) && !in_array($tachyon_motion_amount, $allowedValues)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'tachyon_motion_amount', must be one of '%s'",
                    implode("', '", $allowedValues)
    ...
    {
        $allowedValues = $this->getTachyonFallbackSizeAllowableValues();
        if (!is_null($tachyon_fallback_size) && !in_array($tachyon_fallback_size, $allowedValues)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'tachyon_fallback_size', must be one of '%s'",
                    implode("', '", $allowedValues)
    ...
    {
        $allowedValues = $this->getTachyonMblockSizeAllowableValues();
        if (!is_null($tachyon_mblock_size) && !in_array($tachyon_mblock_size, $allowedValues)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'tachyon_mblock_size', must be one of '%s'",
                    implode("', '", $allowedValues)
     ...
     *
     * @param float $tachyon_cut_detection_sensitivity tachyon_cut_detection_sensitivity
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getEac3BitstreamModeAllowableValues();
        if (!is_null($eac3_bitstream_mode) && !in_array($eac3_bitstream_mode, $allowedValues)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'eac3_bitstream_mode', must be one of '%s'",
                    implode("', '", $allowedValues)
    ...
    {
        $allowedValues = $this->getEac3AnalogToDigitalConverterTypeAllowableValues();
        if (!is_null($eac3_analog_to_digital_converter_type) && !in_array($eac3_analog_to_digital_converter_type, $allowedValues)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'eac3_analog_to_digital_converter_type', must be one of '%s'",
                    implode("', '", $allowedValues)
     ...
     *
     * @param string $eac3_stereo_downmix_preference eac3_stereo_downmix_preference
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getEac3StereoDownmixPreferenceAllowableValues();
        if (!is_null($eac3_stereo_downmix_preference) && !in_array($eac3_stereo_downmix_preference, $allowedValues)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'eac3_stereo_downmix_preference', must be one of '%s'",
                    implode("', '", $allowedValues)
    ...
    {
        $allowedValues = $this->getEac3LtRtCenterMixLevelAllowableValues();
        if (!is_null($eac3_lt_rt_center_mix_level) && !in_array($eac3_lt_rt_center_mix_level, $allowedValues)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'eac3_lt_rt_center_mix_level', must be one of '%s'",
                    implode("', '", $allowedValues)
    ...
    {
        $allowedValues = $this->getEac3LtRtSurroundMixLevelAllowableValues();
        if (!is_null($eac3_lt_rt_surround_mix_level) && !in_array($eac3_lt_rt_surround_mix_level, $allowedValues)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'eac3_lt_rt_surround_mix_level', must be one of '%s'",
                    implode("', '", $allowedValues)
    ...
    {
        $allowedValues = $this->getEac3LoRoCenterMixLevelAllowableValues();
        if (!is_null($eac3_lo_ro_center_mix_level) && !in_array($eac3_lo_ro_center_mix_level, $allowedValues)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'eac3_lo_ro_center_mix_level', must be one of '%s'",
                    implode("', '", $allowedValues)
    ...
    {
        $allowedValues = $this->getEac3LoRoSurroundMixLevelAllowableValues();
        if (!is_null($eac3_lo_ro_surround_mix_level) && !in_array($eac3_lo_ro_surround_mix_level, $allowedValues)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'eac3_lo_ro_surround_mix_level', must be one of '%s'",
                    implode("', '", $allowedValues)
    ...
    {
        $allowedValues = $this->getEac3SurroundExModeAllowableValues();
        if (!is_null($eac3_surround_ex_mode) && !in_array($eac3_surround_ex_mode, $allowedValues)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'eac3_surround_ex_mode', must be one of '%s'",
                    implode("', '", $allowedValues)
    ...
    {
        $allowedValues = $this->getEac3DrcLineModeProfileAllowableValues();
        if (!is_null($eac3_drc_line_mode_profile) && !in_array($eac3_drc_line_mode_profile, $allowedValues)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'eac3_drc_line_mode_profile', must be one of '%s'",
                    implode("', '", $allowedValues)
    ...
    {
        $allowedValues = $this->getEac3DrcRfModeProfileAllowableValues();
        if (!is_null($eac3_drc_rf_mode_profile) && !in_array($eac3_drc_rf_mode_profile, $allowedValues)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'eac3_drc_rf_mode_profile', must be one of '%s'",
                    implode("', '", $allowedValues)
     ...
     * Sets eac3_room_type
     *
     * @param string $eac3_room_type eac3_room_type
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getEac3RoomTypeAllowableValues();
        if (!is_null($eac3_room_type) && !in_array($eac3_room_type, $allowedValues)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'eac3_room_type', must be one of '%s'",
                    implode("', '", $allowedValues)

 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ProfileBody implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['preset_name'] === null) {
            $invalidProperties[] = "'preset_name' can't be null";
        }
        ...
        $allowedValues = $this->getCodecPresetAllowableValues();
        if (!in_array($this->container['codec_preset'], $allowedValues)) {
            $invalidProperties[] = sprintf(
    ...
    {
        $allowedValues = $this->getPresetNameAllowableValues();
        if (!in_array($preset_name, $allowedValues)) {
     ...
     * Sets segment_time
     *
     * @param string $segment_time segment_time
     *
     * @return $this
     */
     ...
     * Sets video_bitrate
     *
     * @param int $video_bitrate video_bitrate
     *
     * @return $this
     */
     ...
     *
     * @param string $byte_range_requests byte_range_requests
     *
     * @return $this
     */
     ...
     * Sets use_editlist
     *
     * @param string $use_editlist use_editlist
     *
     * @return $this
     */
     ...
     *
     * @param string $audio_stream_id audio_stream_id
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getCodecPresetAllowableValues();
        if (!is_null($codec_preset) && !in_array($codec_preset, $allowedValues)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'codec_preset', must be one of '%s'",
                    implode("', '", $allowedValues)
     ...
     * Sets color_metadata
     *
     * @param string $color_metadata color_metadata
     *
     * @return $this
     */
     ...
     * Sets dynamic_recipe
     *
     * @param string $dynamic_recipe dynamic_recipe
     *
     * @return $this
     */
     ...
     * Sets preset_version
     *
     * @param string $preset_version preset_version
     *
     * @return $this
     */
     ...
     *
     * @param string $segment_delimiter segment_delimiter
     *
     * @return $this
     */
     ...
     * Sets sws_flags
     *
     * @param string $sws_flags sws_flags
     *
     * @return $this
     */
     ...
     *
     * @param string $telestream_subpel_mode telestream_subpel_mode
     *
     * @return $this
     */
     ...
     *
     * @param string $vantage_group_id vantage_group_id
     *
     * @return $this
     */
     ...
     *
     * @param string $watermark_bumpers watermark_bumpers
     *
     * @return $this
     */
     ...
     *
     * @param string $watermark_trailers watermark_trailers
     *
     * @return $this
     */
     ...
     *
     * @param object $workorder_criteria workorder_criteria
     *
     * @return $this
     */

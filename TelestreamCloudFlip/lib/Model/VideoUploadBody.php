 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class VideoUploadBody implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'file_size' => 'int',
        'file_name' => 'string',
        'extra_files' => '\TelestreamCloudFlip\Model\ExtraFile[]',
        'profiles' => 'string',
        'path_format' => 'string',
        'payload' => 'string',
     ...
     * Gets extra_files
     *
     * @return \TelestreamCloudFlip\Model\ExtraFile[]
     */
     ...
     * Sets extra_files
     *
     * @param \TelestreamCloudFlip\Model\ExtraFile[] $extra_files A list of names of additional files that will be uploaded.
     *
     * @return $this
     */
     ...
     * Sets multi_chunk
     *
     * @param bool $multi_chunk multi_chunk
     *
     * @return $this
     */

 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PaginatedEncodingsCollection implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'encodings' => '\TelestreamCloudFlip\Model\Encoding[]',
        'page' => 'int',
        'per_page' => 'int',
        'total' => 'int'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['encodings'] === null) {
            $invalidProperties[] = "'encodings' can't be null";
        }
     ...
     * Sets encodings
     *
     * @param \TelestreamCloudFlip\Model\Encoding[] $encodings encodings
     *
     * @return $this
     */
